module LevelData (levels) where

import Level exposing (Model, Tile)
import Dict
...
makeLevel: List (List LevelDescription) -> Model
makeLevel description =
    let
        ...
        reducer: (Int, Int, LevelDescription) -> Model -> Model
